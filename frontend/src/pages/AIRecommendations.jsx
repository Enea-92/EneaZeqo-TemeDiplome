...
const AIRecommendations = () => {
  ...
  const generateRecommendations = async () => {
    ...
    const missingInputs = steps.some(s => !inputs[s.name]);
    if (missingInputs) {
        ...
        <div className="w-full max-w-7xl mx-auto mt-2 px-4">
          ...
          <div className="text-center mt-6">
            <button
              ...
              className="px-6 py-2 rounded-lg font-semibold transition border-2 border-[#e50914] text-white bg-[#e50914] hover:bg-[#b0060f]"
            >
            ...
            <div className="flex justify-between items-center mt-6">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg font-semibold transition border-2 border-[#e50914] text-white bg-[#e50914] hover:bg-[#b0060f] ml-2 ${
                  !inputs[steps[step].name] || isLoading
