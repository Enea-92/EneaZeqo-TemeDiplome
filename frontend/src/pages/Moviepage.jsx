            ...
            <div className="flex gap-3 mt-4">
              {trailerKey ? (
                <a href={`https://www.youtube.com/watch?v=${trailerKey}`} target="_blank" rel="noreferrer">
                  <button className="flex justify-center items-center bg-[#e50914] text-white py-3 px-6 rounded-full cursor-pointer text-sm md:text-base hover:bg-[#b0060f] transition">
                    <Play className="mr-2 w-4 h-5 md:w-5 md:h-5" /> Watch Trailer
                  </button>
                </a>
              ) : (
                <button disabled className="flex justify-center items-center bg-[#e50914] opacity-50 text-white py-3 px-6 rounded-full text-sm md:text-base cursor-not-allowed">
                  <Play className="mr-2 w-4 h-5 md:w-5 md:h-5" /> No Trailer
                </button>
              )}
            </div>
          </div>
